...
public interface JeepSalesController {
  ...
  @Operation(
      ...
      parameters = {
          @Parameter(
              name = "model", allowEmptyValue = false, required = false, description = "The model name (i.e. 'WRANGER')"),
          @Parameter(
              name = "trim", allowEmptyValue = false, required = false, description = "The trim level (i.e. 'Sport')")
